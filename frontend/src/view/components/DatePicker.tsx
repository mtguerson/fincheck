...
interface DatePikcerProps {
  value: Date;
  onChange?(date: Date): void;
}

export function DatePicker({ value, onChange }: DatePikcerProps) {
  return (
    <DayPicker
      locale={ptBR}
      selected={value}
      ...
      classNames={{
        ...
        nav_button_next: "text-teal-800 flex items-center justify-between !bg-transparent",
